...
## i3
mkdir -p ~/.config/i3
curl https://raw.githubusercontent.com/Shadient/linux-mint-config/i3/config > ~/.config/i3/config

## Polybar
mkdir -p ~/.config/polybar
curl https://raw.githubusercontent.com/Shadient/linux-mint-config/polybar/config > ~/.config/polybar/config
